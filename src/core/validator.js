...
export function validateRule(rule, expected, value, message, rules, messages, property, obj, schema) {
...
export function validateValue(value, rules = {}, messages = {}, property, obj, schema) {
  return new Promise((resolve, reject) => {
...
export function validateProperty(property, obj, properties = {}, rules = {}, messages = {}) {
  return new Promise((resolve, reject) => {
    ...
    validateValue(value, propertyRules, propertyMessages, property, obj, properties)
